...
// you can instead reduce the alphabet size and
// create your own mapping of character to index in array
...
int main() {
    ...
    // Construct trie
    int i;
    for (i = 0; i < sizeof(keys) / sizeof(keys[0]); i++) insert(root, keys[i]);
